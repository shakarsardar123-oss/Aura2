...
class _VisionScreenState extends ConsumerState<VisionScreen> {
  ...
  Future<void> _initCamera() async {
    ...
    final camGranted = await permHelper.requestSingleWithRationale(
    ...
    return Stack(
      ...
      children: [
        ...
        if (_lastResult != null &&
          ...
          VisionOverlay(
            result: _lastResult!,
            onTargetTap: (VisionTarget target) {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Close button to reset to ready
              SizedBox(height: 8),
              Align(
      ...
      child: GlassCard(
        ...
        child: Row(
          children: [
            ...
            // Retry button to reset to ready
            IconButton(
              onPressed: _resetToReady,
              icon: Icon(Icons.refresh_rounded, color: cs.error, size: 20),
              tooltip: l10n.retry,
              padding: EdgeInsets.zero,
              constraints: const BoxConstraints(),
            ),
