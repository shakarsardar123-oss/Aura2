...
class MainActivity : FlutterActivity() {
    ...
    private fun getAssistantAvailability(): String {
        ...
        // API 29+ has RoleManager
        return if (isAuraDefaultAssistant()) "active" else "available"
    }
    ...
    /**
     * Opens the system assistant-role settings.
     * On API 29+: uses RoleManager.createRequestRoleIntent()
     * On older: falls back to voice input settings.
     */
